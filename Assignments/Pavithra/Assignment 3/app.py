...
COS_API_KEY_ID="1oHpNB9OlrCKTVVELfjEmZhVLG1wvpSKkSA7LyNMWBMT"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/0a068c4b9d3f4d0f83e5ff02bfdaa0e3:d41df636-4019-453b-a6fe-48009ed70a47::"
...
@app.route('/')
def index():
    files = get_bucket_contents('powernm-images')
